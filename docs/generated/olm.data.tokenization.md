# olm.data.tokenization

### *class* olm.data.tokenization.HFTokenizer(model_path: str)
...
### *class* olm.data.tokenization.TokenizerBase
...
| [`base`](olm.data.tokenization.base.md#module-olm.data.tokenization.base)                                  |    |
|------------------------------------------------------------------------------------------------------------|----|
| [`hf_tokenizer`](olm.data.tokenization.hf_tokenizer.md#module-olm.data.tokenization.hf_tokenizer)          |    |
| [`hf_train_custom`](olm.data.tokenization.hf_train_custom.md#module-olm.data.tokenization.hf_train_custom) |    |
