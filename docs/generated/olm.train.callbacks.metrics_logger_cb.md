...
| [`MetricsLoggerCallback`](#olm.train.callbacks.metrics_logger_cb.MetricsLoggerCallback)([log_dir, log_every])   | Callback to log metrics to a JSONL file.   |
|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------|

### *class* olm.train.callbacks.metrics_logger_cb.MetricsLoggerCallback(log_dir: str = 'logs', log_every: int = 10)
...
### *class* olm.train.callbacks.metrics_logger_cb.Path(\*args, \*\*kwargs)
...
### *class* olm.train.callbacks.metrics_logger_cb.TrainerCallback
