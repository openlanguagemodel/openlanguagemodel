...
| [`LinearDecayLR`](#olm.train.schedulers.linear.LinearDecayLR)(\*args, \*\*kwargs)   | Simple linear decay scheduler that decays to zero.   |
|-------------------------------------------------------------------------------------|------------------------------------------------------|
| [`LinearLR`](#olm.train.schedulers.linear.LinearLR)(\*args, \*\*kwargs)             | Linear learning rate scheduler.                      |

### *class* olm.train.schedulers.linear.LinearDecayLR(\*args: [Any](olm.data.datasets.base_dataset.md#olm.data.datasets.base_dataset.Any), \*\*kwargs: [Any](olm.data.datasets.base_dataset.md#olm.data.datasets.base_dataset.Any))
...
### *class* olm.train.schedulers.linear.LinearLR(\*args: [Any](olm.data.datasets.base_dataset.md#olm.data.datasets.base_dataset.Any), \*\*kwargs: [Any](olm.data.datasets.base_dataset.md#olm.data.datasets.base_dataset.Any))
...
### *class* olm.train.schedulers.linear.SchedulerBase(\*args: [Any](olm.data.datasets.base_dataset.md#olm.data.datasets.base_dataset.Any), \*\*kwargs: [Any](olm.data.datasets.base_dataset.md#olm.data.datasets.base_dataset.Any))
