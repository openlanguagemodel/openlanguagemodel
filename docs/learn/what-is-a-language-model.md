...
The tool that does this splitting is the **tokenizer**. If you want to play with
tokenization directly, try the [OpenAI tokenizer](https://platform.openai.com/tokenizer).
Now let's watch OLM turn text into IDs.
