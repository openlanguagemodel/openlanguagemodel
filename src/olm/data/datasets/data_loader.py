...
def create_dataloader(
    ...
    **kwargs,
    ...
    """
    Convenience function to create a DataLoader with common defaults.

    Args:
        dataset: Dataset to load from.
        batch_size: Number of samples per batch.
        num_workers: Number of worker processes.
        pin_memory: If True, use pinned memory for GPU.
        shuffle: Whether to shuffle data (auto-detected if None).
    ...
    Example:
        >>> from olm.data.datasets import create_dataloader
